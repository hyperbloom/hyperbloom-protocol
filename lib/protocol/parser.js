...
Parser.prototype._parseOpen = function _parseOpen() {
  ...
  this.emit('open', open, { pending, nonce: open.nonce });

  return true;
};

Parser.prototype._resumeParsing = function _resumeParsing(extra) {
  this._waiting = 1;
  this._state = 'msg:length';
