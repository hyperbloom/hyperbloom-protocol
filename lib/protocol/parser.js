...
Parser.prototype._parseOpen = function _parseOpen() {
  ...
  this._paused.nonce = open.nonce;
  this._paused.data = pending;

  this.emit('open', open, pending);
...
Parser.prototype._resumeParsing = function _resumeParsing() {
  ...
  this._xor.remote.update(this._paused.data, this._paused.data);
  this._pending.push(this._paused.data);
  this._paused.data = null;

  this._handshake(this._paused.nonce);
  this._paused.nonce = null;
